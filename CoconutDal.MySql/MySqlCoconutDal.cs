...
namespace CoconutDal.MySql
{
    ...
    /// </summary>
    public class MySqlCoconutDal : ICoconutDal
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the last caught exception. Only MySqlExceptions are caught.
        /// </summary>
        ...
        /// <summary>
        /// Creates a new instance of MySqlCoconutDal, using the supplied connection string
        /// </summary>
        /// <param name="connectionString">A sql server connection string</param>
        public MySqlCoconutDal(string connectionString)
        {
        ...
        {
            return new MySqlCommand(command, (MySqlConnection)conn);
        }
            ...
            try
            {
                using (var conn = this.GetDbConnection())
                {
                    ...
                    using (var cmd = this.GetDbCommand(command, conn))
                    {
                        ...
                        {
                                throw new NotImplementedException("MySql select identity not implemented.");
                        }
